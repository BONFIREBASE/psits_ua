    ...
    <div className="p-6 sm:p-8 max-w-6xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <div className="flex items-center gap-2.5">
            <h1 className="font-display font-black text-2xl text-foreground-theme tracking-tight">Treasury</h1>
      ...
      {showForm && (
        <div className="p-6 rounded-xl border border-border-theme bg-surface-theme shadow-sm space-y-4">
          <h2 className="font-display font-bold text-base text-foreground-theme">New Financial Report / Disbursement</h2>
      ...
      {loading ? (
        ...
        <EmptyState
          icon={<Landmark size={24} className="text-muted-foreground-theme/40" />}
          ...
          {reports.map((rep) => (
            ...
            >
              <div className="w-10 h-10 rounded-lg bg-slate-100 dark:bg-white/[0.05] border border-border-theme flex items-center justify-center flex-shrink-0">
                <Landmark size={16} className="text-amber-600 dark:text-gold/60" />
              </div>
              <div className="flex-1 min-w-0 space-y-1">
                ...
                {rep.description && (
                  <p className="text-xs text-muted-foreground-theme line-clamp-2 mt-1">{rep.description}</p>
                )}
              </div>
